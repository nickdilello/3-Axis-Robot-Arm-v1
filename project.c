...
void motionhome()
{
	TA0CCR1 = 1500;								//servo1 (base) at 0deg
	delay();
	TA1CCR1 = 1500;								//servo2 (arm) at 0deg
	delay();	
	TA1CCR2 = 1500;								//servo3 (gripper) at 0deg
	delay();
}

//Robot Arm Motion Path 1 - GRAB AND DELIVER KLEENEX
void motionpath1()
{
	TA1CCR2 = 2200;								//servo3 (gripper)
	delay();	
	TA1CCR1 = 2300;								//servo2 (arm)
	delay();
	TA1CCR2 = 1000;								//servo3 (gripper)
	delay();
	TA1CCR1 = 800;								//servo2 (arm)
	delay();
	TA0CCR1 = 1000;								//servo1 (base) at 0deg	
	delay();
	TA1CCR2 = 2000;								//servo3 (gripper)
	delay();
}

//Robot Arm Motion Path 2 - GRAB AND DROP MONKEY
void motionpath2()
{
	TA1CCR2 = 2200;								//servo3 (gripper)
	delay();	
	...
	delay();
	TA0CCR1 = 800;								//servo1 (base) at 0deg	
	delay();
	TA1CCR2 = 2000;								//servo3 (gripper)
	delay();	
}

//Robot Arm Motion Path 3
void motionpath3()
{	
	TA1CCR2 = 1000;
	delay();	
